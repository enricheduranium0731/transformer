...
small_green_font = {'fontname': 'Arial',
                    ...
                    'weight':   'bold',
                    'va':       'bottom'}
normal_label_font = {'fontname': 'SimSun',
                     'size':     '12',
                     'color':    'black',
                     'weight':   'normal',
                     'va':       'bottom',
...
class InterCandle:
    def __init__(self, data, my_style,product,idx_start,idx_range):
        self.pressed = False
        self.xpress = None
        ...
        self.fig = mpf.figure(style=my_style, figsize=(22,12), facecolor=(0.82, 0.83, 0.85))
        fig = self.fig
        ...
        self.t1 = fig.text(0.50, 0.94, product, **title_font)
    ...
    def refresh_plot(self, idx_start, idx_range):
        ...
        add_plot_long=mpf.make_addplot(plot_data['signal_long'],scatter=True,markersize=120,marker='^',color='b',ax=self.ax1)
        add_plot_short=mpf.make_addplot(plot_data['signal_short'],scatter=True,markersize=120,marker='v',color='r',ax=self.ax1)
        add_plot_close=mpf.make_addplot(plot_data['signal_close'],scatter=True,markersize=120,marker='o',color='y',ax=self.ax1)
        add_plot=[add_plot_long,add_plot_short,add_plot_close]
...
if __name__ == '__main__':
    ...
    candle.idx_start = 500
    candle.idx_range = 500
    candle.refresh_texts(data.iloc[249])
    candle.refresh_plot(500, 100)
